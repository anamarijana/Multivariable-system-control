...
grid
title('\rm Fa')
sgtitle({'Odskočni odziv zatvorene sprege',' decentralizovan kontroler',' dekuplovanje na učestanosti propusnog opsega'})%,'fontweight','bold','fontsize',14);
...
sgtitle({'Singularne karakteristike zatvorene sprege',' decentralizovan kontroler',' dekuplovanje na učestanosti propusnog opsega'})
