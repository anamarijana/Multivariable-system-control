...
%% projektovanje Hinf upravljanja
[K, N, Hinf] = mixsyn(G,Ws1,Wks,[],'DISPLAY','on');
...
grid
title('\rm Fa')
sgtitle({'Odskočni odziv zatvorene sprege',' multivarijabilan kontroler',' H_{\infty}'})%,'fontweight','bold','fontsize',14);
...
sgtitle({'Singularne karakteristike zatvorene sprege',' multivarijabilan kontroler',' H_{\infty}'})
